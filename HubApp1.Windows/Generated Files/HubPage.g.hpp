...
void ::HubApp1::HubPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::HubApp1::HubPage::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::Hub^>(target))->SectionHeaderClick +=
            ref new ::Windows::UI::Xaml::Controls::HubSectionHeaderClickEventHandler(this, (void (::HubApp1::HubPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::HubSectionHeaderClickEventArgs^))&HubPage::Hub_SectionHeaderClick);
        break;
    case 2:
        (safe_cast<::Windows::UI::Xaml::Controls::ListViewBase^>(target))->ItemClick +=
            ref new ::Windows::UI::Xaml::Controls::ItemClickEventHandler(this, (void (::HubApp1::HubPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::ItemClickEventArgs^))&HubPage::ItemView_ItemClick);
        break;
    }
