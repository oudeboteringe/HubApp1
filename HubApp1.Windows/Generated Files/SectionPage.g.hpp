...
void ::HubApp1::SectionPage::InitializeComponent()
{
    if (_contentLoaded)
        return;
...
void ::HubApp1::SectionPage::Connect(int connectionId, Platform::Object^ target)
{
    switch (connectionId)
    {
    case 1:
        (safe_cast<::Windows::UI::Xaml::Controls::ListViewBase^>(target))->ItemClick +=
            ref new ::Windows::UI::Xaml::Controls::ItemClickEventHandler(this, (void (::HubApp1::SectionPage::*)(Platform::Object^, Windows::UI::Xaml::Controls::ItemClickEventArgs^))&SectionPage::ItemView_ItemClick);
        break;
    }
